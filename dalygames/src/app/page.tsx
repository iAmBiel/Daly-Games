  ...
  return (
    ...
    <main className="w-full">
      <Container>
        ...
        <h1 className="text-center font-bold text-xl mt-8 mb-5 text-white">Separamos um jogo exclusivo pra você !</h1>
        ...
        <h2 className="text-lg font-bold mt-8 mb-5 text-white">
          Jogos para conhecer
        </h2>
