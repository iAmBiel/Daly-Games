...
export const metadata: Metadata = {
  ...
  description: "Perfil Gabriel Vieira | Daly Games sua plataforma de jogos!"
}
      ...
      <Container>
        ...
        >
          <div className="w-full flex items-center gap-4 text-lg flex-col sm:flex-row justify-center sm:justify-normal">
            ...
            <h1 className="font-bold text-2xl text-white">Gabriel Vieira</h1>
          </div>

          <div className="sm:absolute top-0 right-0 gap-3 flex items-center justify-center mt-2">
            <button className="bg-gameDetailTag px-4 py-3 rounded-lg text-white">
              Configurações
            </button>
            <button className="bg-gameDetailTag px-4 py-3 rounded-lg">
